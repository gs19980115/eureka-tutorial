...
public class EurekaClientApplicationTests {
    ...
    public void shouldRegisterClientInEurekaServer() throws InterruptedException {
        ...
        ResponseEntity<String> response = this.testRestTemplate.getForEntity("http://localhost:" + this.port + "/service-instances/namenode", String.class);

        then(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        then(response.getBody()).contains("namenode");
    }
